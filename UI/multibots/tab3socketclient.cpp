...
#include "ui_tab3socketclient.h"

Tab3SocketClient::Tab3SocketClient(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::Tab3SocketClient)
{
    ui->setupUi(this);
...
void Tab3SocketClient::slotConnectToServer(bool check)
{
    bool bOk;
    if(check) {
...
void Tab3SocketClient::slotSocketRecvUpdate(QString strRecvData)
{
...
void Tab3SocketClient::slotSocketSendData()
{
    QString strRecvId;
    QString strSendData;
...
void Tab3SocketClient::slotSocketSendData(QString strData)
{
    if(ui->pPBServerConnect->isChecked())
        pSocketClient->slotSocketSendData(strData);
}

Tab3SocketClient::~Tab3SocketClient()
{
    delete ui;
}
